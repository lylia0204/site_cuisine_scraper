...
var urlPrincpale = 'https://www.750g.com/recettes_sans_gluten.htm?page=4'
...
const scrap = async () => {
    ...
    fs.writeFileSync('../json/750gRecetteSansGluten4.json', data)
