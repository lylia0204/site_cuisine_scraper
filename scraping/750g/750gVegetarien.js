...
var urlPrincpale = 'https://www.750g.com/recettes_cuisine_vegetarienne.htm?page=4'
...
const scrap = async () => {
    ...
    fs.writeFileSync('../json/750gRecetteVegetarienne4.json', data)
